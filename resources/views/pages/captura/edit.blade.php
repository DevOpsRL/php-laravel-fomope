                        ...
                        <div class="card-body ">
                            ...
                            @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="hidden" value="{{$fmov->grupo}}" name="grupo" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control col-md-3" value="{{$dato->elaboracion}}" name="elaboracion" id="f_elab" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{$dato->genero}}" name="genero">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            @foreach ($civil as $cv )
                                            <option value="{{$cv->id}}" 
                                                @if ($cv->id == $dato->civil) selected @endif> 
                                                {{$cv->descr}}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <select class="form-control" name="hijos">
                                                <option value="1" @if ($dato->hijos == 1)  selected @endif>SI</option>
                                                <option value="0"@if ($dato->hijos != 0)  selected @endif>NO</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{$dato->cr_cur}}" name="cr_descr"/>
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <select class="form-control" name="horas">
                                                ...
                                                <option value="8" @if ($dato->horas == 8) selected @endif>08 HORAS</option>
                                                <option value="7" @if ($dato->horas == 7) selected @endif>07 HORAS</option>
                                                <option value="6" @if ($dato->horas == 6) selected @endif>06 HORAS</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="col-md-3"></div>
                                    <div class="col-md-3">
                                        <button class="btn btn-outline-primary active" type="submit" id="button-addon2">ACTUALIZAR</button>
                                    </div>
